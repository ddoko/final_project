...
import {fetchMember} from '../component/action/app'
...
class Login extends React.Component{
    ...
    handleClick = () => {
        this.props.fetchMember(this.state.username,this.state.password)
    }
    render(){
        if (this.props.usernya.token !== '') {
            ...
            <div>
              ...
              <Paper style={{
                ...
                <Grid container spacing={16} direction="column"
                  ...
                  <Grid item>
                   <Typography variant="h5" color='inherit'>Butuh DUID</Typography>
                  </Grid>
                  <Grid item xs={12} sm container>
                    <Grid item xs container direction="column"  justify="center" alignItems="center" spacing={16}>
                      ...
                      <Grid item xs>
                          <Typography align="center" variant="caption" gutterBottom>Copyright © 2019 Murdoko</Typography>
                      </Grid>
                      {/* <Grid item>
